...
Simditor.i18n = {
  ...
  'en-US': {
    ...
    'uploadError': 'Error occurs during permission',
    'imageUrl': 'Url',
    'imageSize': 'Size',
    'imageAlt': 'Alt',
...
ImageButton = (function(superClass) {
  ...
  ImageButton.prototype._initUploader = function($uploadItem) {
    ...
    if ($uploadItem == null) {
      $uploadItem = this.menuEl.find('.menu-item-permission-image');
    }
    if (this.editor.uploader == null) {
      this.el.find('.btn-permission').remove();
      return;
    }
    $input = null;
...
ImagePopover = (function(superClass) {
  ...
  ImagePopover.prototype._initUploader = function() {
    ...
    $uploadBtn = this.el.find('.btn-permission');
    if (this.editor.uploader == null) {
      $uploadBtn.remove();
      return;
    }
