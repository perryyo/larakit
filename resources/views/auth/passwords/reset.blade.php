            ...
            <div class="form-content">
                <div class="form-items">
                    ...
                    <div class="page-links">
                        <a href="http://brandio.io/envato/iofrm/html/login5.html" class="active">{{ __('Reset Password') }}</a>
                    </div>
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" placeholder="E-mail Address"  value="{{ $email ?? old('email') }}" required autofocus>
                    ...
                    @if ($errors->has('email'))
                        ...
                        <div class="form-button">
                            <button id="submit" type="submit" class="ibtn">{{ __('Reset Password') }}</button>
