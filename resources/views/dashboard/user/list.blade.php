            ...
            <div class="col s12 m12 l6">
                <div class="card">
                    <div class="card-content">
                        <div class="row">
                        <span class="card-title">فهرست کاربران</span>
                            <br>
                            @if(count($list)>0)
                        ...
                        <div class="input-field col s1" style="width: 100px;">
                            ...
                            @endif
                                ...
                                <div class="input-field col s2">
                                    <a href="/admin/{{ $node }}/add"    class="waves-effect waves-light btn pink m-b-xs">افزودن</a>
                            ...
                            <tr>
                                ...
                                <td><a class='dropdown-button btn' href='#' data-activates='dropdown{{ $item->id }}'>انتخاب عملیات</a>
                                    ...
                                    <ul id='dropdown{{ $item->id }}' class='dropdown-content'>
                                        <li><a href="/admin/{{ $node }}/{{ $item->id }}/role"><i class="fas fa-eye"></i>تخصیص نقش</a></li>
                                        <li class="divider"></li>
                                        <li><a href="/admin/{{ $node }}/{{ $item->id }}"><i class="fas fa-user-edit"></i> ویرایش</a></li>
                                        <li><a href="/admin/{{ $node }}/{{ $item->id }}/show"><i class="fas fa-eye"></i> مشاهده</a></li>
                                        <li class="divider"></li>
                                        <li><a href="/admin/{{ $node }}/{{ $item->id }}/delete"><i class="fas fa-trash-alt"></i> حذف</a></li>
                                    </ul></td>
                             </tr>
                            @endforeach
